        ...
        for y in range(self.fighter_num):
            ...
            if obs_dict['fighter_obs_list'][y]['alive']:
                ...
                if (obs_dict['fighter_obs_list'][y]['j_recv_list']):
                    print('%d:被动雷达发现目标' % obs_dict['fighter_obs_list'][y]['id'])
                    print('发现列表：', obs_dict['fighter_obs_list'][y]['j_recv_list'])
                ...
                if (obs_dict['fighter_obs_list'][y]['r_visible_list']):
                    print('%d:主动雷达发现目标' % obs_dict['fighter_obs_list'][y]['id'])
                    print('发现列表：', obs_dict['fighter_obs_list'][y]['r_visible_list'])
