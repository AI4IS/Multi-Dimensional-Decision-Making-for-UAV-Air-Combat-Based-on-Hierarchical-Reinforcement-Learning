...
class Agent:
    ...
    def get_action(self, obs_dict, step_cnt):
        ...
        #
        #     if not obs_dict['fighter_obs_list'][y]['alive'] and (obs_dict['fighter_obs_list'][y]['id'] not in TRASH_LIST):
        #         print('*'*100)
        #         print("击毁目标:",obs_dict['fighter_obs_list'][y]['id'])
        #         TRASH_LIST.append(obs_dict['fighter_obs_list'][y]['id'])
